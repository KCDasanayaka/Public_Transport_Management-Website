  ...
  return (
    <div className='home'>
      ...
      <div className='homeContent'>
        <div className='homeRegText'></div>
        <div className="regLeftlogo">
          <img src={logoImg} alt='Company Logo' className='logoImg' />
          <div className="homeRegleft">
            <div className="regLeft1">
              <h1>Select<br />
                <span style={{ textTransform: 'capitalize' }}>Bus Type</span>
              </h1>
            </div>
            ...
            <div className="homeRegBtn02">
              <button>
                <div className='homeBtn'>
                  <div className="homeBtn1" style={{ marginRight: '5%' }}>
                    <img src={BusSign} alt='Bus Sign' className='busSign' />
                  </div>
